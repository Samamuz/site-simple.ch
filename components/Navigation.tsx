      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 h-20 flex items-center justify-between relative z-50">
        ...
        <div className="flex md:hidden">
          <button 
            ...
            className="group w-10 h-10 flex flex-col items-center justify-center gap-[6px] p-2"
            aria-label={isOpen ? "Fermer le menu" : "Ouvrir le menu"}
          >
            <span className={`block h-[2px] w-6 bg-black transition-transform duration-300 ease-in-out origin-center ${
              isOpen ? 'translate-y-[8px] rotate-45' : ''
            }`}></span>
            <span className={`block h-[2px] w-6 bg-black transition-opacity duration-300 ease-in-out ${
